...
```
!plugin get https://github.com/Ingnaryk/LangBot_AzureTTS
```
或查看详细的[插件安装说明](https://docs.langbot.app/plugin/plugin-intro.html#%E6%8F%92%E4%BB%B6%E7%94%A8%E6%B3%95)

## 使用

1. 注册/登录[Azure](https://portal.azure.com)控制台
2. 搜索**语音服务**并创建，根据指示创建资源组及其相关配置
3. 复制配置界面中的**密钥**和“终结点”中的**服务区域**，插件加载时会在所在目录生成*Azure_config.ini*文件，修改对应的**api_key**字段和**region**字段
